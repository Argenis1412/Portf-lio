...
export const LanguageProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const translations: Record<Language, Record<string, string>> = {
    ...
    en: {
      ...
      'nav.journey': 'Journey',
      'nav.contact': 'Contact',
      'hero.subtitle': 'Backend-focused developer with Python, currently studying systems at UFPR. Specialist in building secure and scalable REST APIs, applying hexagonal architecture and automated tests to ensure high-performance solutions with deterministic financial logic.',
