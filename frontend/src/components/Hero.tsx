    ...
    <section id="hero" className="pt-32 pb-16 md:pt-48 md:pb-32 px-4 max-w-6xl mx-auto relative overflow-hidden min-h-[85vh] flex items-center">
      ...
      >
        <div className="text-center md:text-left order-2 md:order-1">
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 text-slate-900 dark:text-slate-100">
          ...
          <p className="mt-4 text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-xl mx-auto md:mx-0">
            {t('hero.subtitle')}
          </p>
          <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
            ...
            <a href="#contact" className="bg-white dark:bg-[#121212] hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-900 dark:text-slate-100 font-semibold py-3 px-8 rounded-full transition-smooth border border-slate-200 dark:border-slate-800">
              {t('nav.contact')}
            </a>
          </div>
        </div>
