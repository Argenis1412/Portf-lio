          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-2">
              <motion.button 
                ...
                className="bg-app-primary hover:bg-app-primary-hover text-white font-bold py-4 px-4 rounded-xl transition-all duration-300 shadow-lg shadow-app-primary/20 disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-widest text-[10px] flex items-center justify-center gap-2 active:scale-95"
              >
                {status === 'loading' ? (
              ...
              <motion.button 
                ...
                className="bg-[#25D366] hover:bg-[#128C7E] text-white font-bold py-4 px-4 rounded-xl transition-all duration-300 shadow-lg shadow-green-500/20 flex items-center justify-center gap-2 uppercase tracking-widest text-[10px] active:scale-95"
              >
              ...
              <motion.button 
                ...
                className="bg-app-surface border border-app-border hover:border-app-primary text-app-text font-bold py-4 px-4 rounded-xl transition-all duration-300 shadow-sm flex items-center justify-center gap-2 uppercase tracking-widest text-[10px] active:scale-95 group"
              >
                {copied ? (
                  <Check className="w-4 h-4 text-emerald-500" />
                ) : (
                  <Copy className="w-4 h-4 group-hover:text-app-primary transition-colors" />
                )}
