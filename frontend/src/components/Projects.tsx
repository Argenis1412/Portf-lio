            ...
            return (
              <div key={project.id} className="glass rounded-2xl p-6 md:p-8 hover:-translate-y-2 transition-smooth group relative overflow-hidden">
                ...
                <div className="flex gap-4 mt-auto">
                  {project.repositorio && (
                    <a href={project.repositorio} target="_blank" rel="noopener noreferrer" className="text-slate-600 dark:text-slate-300 hover:text-amber-600 dark:hover:text-amber-400 transition-colors flex items-center gap-2 text-sm font-semibold">
                  ...
                  {project.demo && (
                    <a href={project.demo} target="_blank" rel="noopener noreferrer" className="text-slate-600 dark:text-slate-300 hover:text-amber-600 dark:hover:text-amber-400 transition-colors flex items-center gap-2 text-sm font-semibold">
